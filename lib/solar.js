        ...
        [
          {
            role: 'system',
            content:
              '당신은 학교 문서에서 추출한 텍스트가 온전한 문장인지 아닌지 가려내는 분류기입니다. 반드시 JSON 배열만 출력합니다.',
          },
          {
            role: 'user',
            content: [
              ...
              '- "문장": 온전한 하나의 문장. 두 어절 이상이고 끝맺음(종결부호 또는 \'~함/~임/~됨/~다\' 같은 종결 표현)이 있는 완결된 서술. 예: "독서를 좋아함.", "수업에 적극 참여하며 발표력이 뛰어남"',
              '- "조각": 온전한 문장이 아닌 것 전부 — 표 머리글·열 제목, 문서 제목, 사람 이름, 날짜·학번, 명사구, 끝맺음 없는 구, 한 단어 표현. 예: "이름", "행동특성 및 종합의견", "김하늘", "책임감이 강한 편", "성실함."',
              '',
              '판단이 애매하면 "조각"으로 분류하세요. 온전한 문장만 중복 비교 대상이 됩니다.',
              '',
              '텍스트 목록:',
              list,
              '',
